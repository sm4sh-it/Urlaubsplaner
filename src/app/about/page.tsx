            ...
            <div className="space-y-8">
              ...
              <div className="relative pl-7 border-l-2 border-brand-500">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1.5 text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <li><strong>Prisma CLI Version Pinning:</strong> <code>prisma@7.10.0</code> wird nun fest im Docker-Runner-Stage vorinstalliert. Schema-Pushes erfolgen lokal ohne Remote-Downloads, wodurch der Container in Millisekunden startet und 100 % offline-fähig ist.</li>
                </ul>
              </div>
              ...
              <div className="relative pl-7 border-l-2 border-slate-200 dark:border-slate-800">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-slate-600 dark:text-slate-400">
                  ...
                  <li><strong>Smart Debt Settlement:</strong> Intelligente Schulden-Minimierung nach Ausgaben-Splits berechnet automatisch die minimale Anzahl an Ausgleichszahlungen („Wer schuldet wem wie viel?“) inklusive Ein-Klick-Export für WhatsApp &amp; Messenger.</li>
                  <li><strong>Manuelle Reise-Synchronisation:</strong> Verknüpfte Reise-Budgets können per Knopfdruck ihre tatsächlichen Gesamtausgaben und geplante Budgetlimits serverlastfrei in die Kalender- und Dashboard-Statistiken übertragen.</li>
                  <li><strong>Smarte Datepicker-Synchronisation:</strong> Auswahl des Startdatums setzt automatisch das Mindestdatum (<code>min</code>) für das Enddatum, wodurch sich der Enddatum-Picker direkt im passenden Monat und Jahr öffnet.</li>
                  <li><strong>Navigation &amp; Menü:</strong> Neuer Hauptnavigationspunkt „Budget“ zwischen Kalenderansicht und Statistiken.</li>
                </ul>
              </div>
              ...
              <div className="relative pl-7 border-l-2 border-slate-200 dark:border-slate-800">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-slate-600 dark:text-slate-400">
                  ...
                  <li><strong>Statistik-Raster &amp; Symmetrische Jahresverläufe:</strong> Neusortiertes 5-Zeilen-Raster ($1/3$ in Zeilen 1–3, $1/4$ in Zeilen 4–5), Ausrichtung des Jahresverlaufs unter der Hauptzahl bei *Ø Urlaubsdauer* sowie Ergänzung des 3-Jahresverlaufs bei *Budget vs. Realität* und *Genutzte Brückentage*.</li>
                  <li><strong>Widget Finetunings &amp; Easter Egg:</strong> *Urlaubsgewohnheiten* mit verbesserter Untertitel-Typografie und versteckter Easter-Egg Statistik („Was ist arbeiten?“ bei Reisen &gt;20 Tage); *Work - No Work* mit neutralem Badge *% Abwesenheit*.</li>
                  <li><strong>Kachel-Matching Button („+ Neue Reise“):</strong> Button im exakten Kachel-Hintergrunddesign mit identischem Lift- &amp; Glow-Mouseover der Reise-Kacheln.</li>
                </ul>
              </div>
              ...
              <div className="relative pl-7 border-l-2 border-slate-200 dark:border-slate-800">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-slate-600 dark:text-slate-400">
                  ...
                  <li><strong>Minimalistisches Mobile-Menü:</strong> Randloses Listen-Design mit Akzentleiste für die aktive Seite und integrierter Profilauswahl.</li>
                  <li><strong>Branding &amp; Jahreswechsler:</strong> "sm4sh's" in Brand-Farbe, vergrößerte Touch-Trefferflächen (`p-2`, 22px Pfeile) und Brand-Farbe bei Mouseover.</li>
                  <li><strong>Kalender-Optimierung:</strong> Transparente Monatsnamen auf Desktop, optimierter Dark-Mode-Kontrast auf Mobile und Ausblenden ungültiger Tage.</li>
                </ul>
              </div>
              ...
              <div className="relative pl-6 border-l-2 border-slate-200 dark:border-slate-800">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-slate-600 dark:text-slate-400">
                  ...
                  <li><strong>Header &amp; Navigation:</strong> Nur Logo-Icon auf Mobile, aufgeräumtes Mobile-Dropdown mit integrierter Profilauswahl und hohem Z-Index (`z-[100]`).</li>
                  <li><strong>Kalenderansicht:</strong> Touch-freundliches horizontales Wischen (`overflow-x-auto`) mit fixer, blickdichter Monatsspalte (`sticky left-0`).</li>
                  <li><strong>Anmeldeseite:</strong> Optimierte Randabstände (`p-5 sm:p-8`), 48px Touch-Ziele (`h-12`) und iOS Auto-Zoom Schutz (`text-base`).</li>
                </ul>
              </div>
              ...
              <div className="relative pl-6 border-l-2 border-slate-200 dark:border-slate-800">
                ...
                <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-slate-600 dark:text-slate-400">
                  ...
                  <li><strong>GitHub Actions:</strong> Einführung von `run-name` für übersichtliche Release-Titel in der Workflow-Übersicht.</li>
                </ul>
              </div>
