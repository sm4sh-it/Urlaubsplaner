    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-5 flex flex-col gap-6">
        ...
        <div className="bg-white dark:bg-[#0d1117] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-5">
          <h2 className="text-base sm:text-lg font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2 pb-4 border-b border-slate-100 dark:border-slate-800">
            <Users className="w-5 h-5 text-brand-500" />
            Vorhandene Profile ({profiles.length})
          </h2>
          <div className="space-y-3">
            {profiles.length === 0 ? (
              <div className="text-slate-400 dark:text-slate-500 text-sm py-4 text-center">Keine Profile angelegt.</div>
            ) : (
              profiles.map(p => (
                <div key={p.id} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-slate-200/80 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="font-bold text-slate-700 dark:text-slate-200 truncate">{p.name}</div>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button 
                      ...
                      className="p-2 text-slate-500 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-white dark:hover:bg-slate-800 rounded-lg transition-colors cursor-pointer"
        ...
        <div className="bg-white dark:bg-[#0d1117] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-slate-700 dark:text-slate-300 text-base">Feiertage &amp; Ferien Daten-Sync</h3>
      ...
      <div className="lg:col-span-7">
        <div className="bg-white dark:bg-[#0d1117] p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl">
          <h2 className="text-base sm:text-lg font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2 pb-4 border-b border-slate-100 dark:border-slate-800 mb-6">
          ...
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm font-medium transition-all" 
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    value={formData.color} 
                    onChange={e => setFormData({...formData, color: e.target.value})} 
                    className="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm font-mono font-medium" 
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm font-medium transition-all cursor-pointer"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-500 focus:outline-none" 
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-500 focus:outline-none" 
              />
            </div>
